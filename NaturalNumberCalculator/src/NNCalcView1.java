...
public final class NNCalcView1 extends JFrame implements NNCalcView {
    ...
    public NNCalcView1() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            this.bDigits[i] = new JButton(number);
        }
        ...
        this.setLayout(new GridLayout(CALC_GRID_ROWS, CALC_GRID_ROWS));
    ...
    public void updateSubtractAllowed(boolean allowed) {
        ...
        //if allowed, show subtract button
        if (allowed) {
